...
```{r seq-ioi, fig.width = 9, fig.height = 4}
...
```{r kot-plot,  echo = FALSE, fig.width = 10}
...
<!-- #### Bar graph for main effect (for presentation purposes) -->

```{r kot-bar-plot, include = FALSE}
...
```{r seq-kot, fig.width = 9, fig.height = 4}
...
```{r vel-plot, echo = FALSE, fig.width = 10}
...
```{r seq-vel, fig.width = 9, fig.height = 4}
...
```{r vel-diff-plot, echo = FALSE, fig.width = 10}
...
```{r seq-vel-diff, fig.width = 9, fig.height = 4}
