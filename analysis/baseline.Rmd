...
ggplot(kot, aes(x = Articulation, y = Mean, color = Dynamics))+
  geom_boxplot(position = position_dodge2(preserve = "single")) +
  geom_point(position = position_dodge(0.75)) +
  facet_grid( ~ Subcomponent1, labeller = as_labeller(c("Legato" = "Legato/Forte", "Staccato" = "Staccato/Piano"))) +
  theme_pubr()
...
ggplot(vel, aes(x = Dynamics, y = Mean, color = Articulation))+ 
  geom_boxplot(position = position_dodge2(preserve = "single")) +
  geom_point(binaxis = "y", stackdir = "center", position = position_dodge(0.75)) +
  facet_grid( ~ Subcomponent2, labeller = as_labeller(c("Forte" = "Forte/Legato", "Piano" = "Piano/Staccato"))) +
  theme_pubr()
...
ggplot(vel_diff, aes(x = Dynamics, y = Mean, color = Articulation))+ 
  geom_boxplot(position = position_dodge2(preserve = "single")) +
  geom_point(position = position_dodge(0.75)) +
  facet_grid( ~ Subcomponent2, labeller = as_labeller(c("FtoP" = "FtoP/PtoF", "PtoF" = "PtoF/StoL"))) +
  theme_pubr()
