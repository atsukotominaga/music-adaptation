...
```{r seq-ioi, fig.width = 12, fig.height = 2.4}
...
```{r seq-kot, fig.width = 12, fig.height = 2.4}
...
```{r seq-vel, fig.width = 12, fig.height = 2.4}
...
```{r seq-vel-diff, fig.width = 12, fig.height = 2.4}
