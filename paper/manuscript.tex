...
Teaching is effective when experts and novices dynamically interact with each other. In the literature of cultural evolution, it has been considered that humans have developed knowledge and skills by imitating knowledgeable others (experts) and transmitting what they acquired to the next generation (Mesoudi, 2016). However, information flows between experts and novices are not unidirectional (i.e., from experts to novices) but rather bidirectional and interactive (Charbonneau \& Strachan, 2022). Experts dynamically adapt their behaviour and scaffold the acquisition process of complex skills, and novices are actively participating in the learning process (Flynn, 2022; Okazaki, Muraoka, \& Osu, 2019).

Exaggeration of movement is often used to signal a communicative intent to others during ongoing interactions (Pezzulo et al., 2019). When experts have the intention to teach, they modulate their behaviour. For instance, when care givers were teaching how to use a novel toy to their infants, they tended to exaggerate the movement paths (Brand, Baldwin, \& Ashburn, 2002). Such exaggeration was observed not only in infant research but also when knowledgeable adults were teaching some knowledge and skills to adult learners (McEllin, Knoblich, \& Sebanz, 2017; Uther, Knoll, \& Burnham, 2007).
