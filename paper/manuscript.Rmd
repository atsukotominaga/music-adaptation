...
ioi_all_plot <- ggplot(ioi[Category != "baseline"], aes(x = Articulation, y = Mean, color = Dynamics)) +
  ...
  geom_point(position = position_jitterdodge(jitter.width = 0.25), alpha = 0.5) + labs(y = "IOI (ms)", title = "IOI") + scale_y_continuous(breaks = seq(240, 320, 20), limits = c(240, 320)) +
  scale_color_aaas() +
