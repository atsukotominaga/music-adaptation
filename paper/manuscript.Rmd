---
title             : "How do expert pianists adapt their didactic demonstration to novices’ skill levels?"
...
Teaching is effective when experts and novices dynamically interact with each other. In the literature of cultural evolution, it has been considered that humans have developed knowledge and skills by imitating knowledgeable others (experts) and transmitting what they acquired to the next generation [@mesoudi_2016a]. However, information flows between experts and novices are not unidirectional (i.e., from experts to novices) but rather bidirectional and interactive [@charbonneau_2022]. Experts dynamically adapt their behaviour and scaffold the acquisition process of complex skills, and novices are actively participating in the learning process [@okazaki_2019; @flynn_2022].

Exaggeration of movement is often used to signal a communicative intent to others during ongoing interactions [@pezzulo_2019]. When experts have the intention to teach, they modulate their behaviour. For instance, when care givers were teaching how to use a novel toy to their infants, they tended to exaggerate the movement paths [@brand_2002]. Such exaggeration was observed not only in infant research but also when knowledgeable adults were teaching some knowledge and skills to adult learners [@mcellin_2017; @uther_2007].
...
Evidence from infant-directed action research has shown that caregivers are sensitive to the infants' skill levels and modified their demonstration according to infants' abilities to perform a motor task [@fukuyama_2015]. In the current experiment, expert pianists needed to perform in the absence of actual students. Future research should investigate how expert pianists and students dynamically interact in a situation where they can communicate as a naturalistic lesson and examine how the performance of expert pianists and that of students are related.
