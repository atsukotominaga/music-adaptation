...
# for forte
excluded_kv_for <- kv[Subcomponent == "Forte" & Mean < kv_all[Subcomponent == "Forte"]$Mean+3*kv_all[Subcomponent == "Forte"]$SD & Mean > kv_all[Subcomponent == "Forte"]$Mean-3*kv_all$SD]
print(excluded_kv_for)
```
- The number of excluded performance: `r kv_all[Subcomponent == "Forte"]$N-nrow(excluded_kv_for)`

#### Piano
```{r outlier_pia, echo = FALSE}
# for piano
excluded_kv_pia <- kv[Subcomponent == "Piano" & Mean < kv_all[Subcomponent == "Piano"]$Mean+3*kv_all[Subcomponent == "Piano"]$SD & Mean > kv_all[Subcomponent == "Piano"]$Mean-3*kv_all$SD]
print(excluded_kv_pia)
```
- The number of excluded performance: `r kv_all[Subcomponent == "Piano"]$N-nrow(excluded_kv_pia)`
