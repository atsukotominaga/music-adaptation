---
title: 'IOIs Analysis for Non-Expressive performances'
output:
...
df_ioi <- fread("./filtered/data_onset.csv", header = T, sep = ",", dec = ".") # read a filtered csv
...
excluded_ioi <- ioi[Mean < mean(ioi$Mean)+3*sd(ioi$SD) & Mean > mean(ioi$Mean)-3*sd(ioi$SD)]
print(excluded_ioi)
```
