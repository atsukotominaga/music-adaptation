---
title: 'Duration Analysis for Performing-Articulation performances'
output:
...
***Duration values from this analysis were used.***
...
dt_onset <- dt_onset_all[Condition == "performing" & Skill == "articulation"]
...
# include only articulation
dt_offset <- dt_offset_all[Condition == "performing" & Skill == "articulation"]
...
duration_trial <- dt_duration[Subcomponent == "Legato" | Subcomponent == "Staccato", .(N = length(normDu), Mean = mean(normDu), SD = sd(normDu)), by = .(SubNr, TrialNr, Subcomponent)]
