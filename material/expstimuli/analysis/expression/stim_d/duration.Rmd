...
duration_trial <- dt_duration[Subcomponent == "Forte" | Subcomponent == "Piano", .(N = length(normDu), Mean = mean(normDu), SD = sd(normDu)), by = .(SubNr, TrialNr, Subcomponent)]
...
# for legato
duration_trial_leg <- dt_duration[Subcomponent == "Legato", .(N = length(normDu), Mean = mean(normDu), SD = sd(normDu)), by = .(SubNr, TrialNr)]
duration_trial_leg
```
...
# for staccato
duration_trial_sta <- dt_duration[Subcomponent == "Staccato", .(N = length(normDu), Mean = mean(normDu), SD = sd(normDu)), by = .(SubNr, TrialNr, Subcomponent)]
duration_trial_sta
```
