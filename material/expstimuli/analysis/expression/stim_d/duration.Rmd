...
Description: This is a rough overview of performing performance (Duration) from teaching-v2.0.
...
# for forte
excluded_duration_for <- duration[Subcomponent == "Forte" & Mean < duration_all[Subcomponent == "Forte"]$Mean+3*duration_all[Subcomponent == "Forte"]$SD & Mean > duration_all[Subcomponent == "Forte"]$Mean-3*duration_all$SD]
print(excluded_duration_for)
```
- The number of excluded performance: `r duration_all[Subcomponent == "Forte"]$N-nrow(excluded_duration_for)`

#### Piano
```{r outlier_sta, echo = FALSE}
# for piano
excluded_duration_pia <- duration[Subcomponent == "Piano" & Mean < duration_all[Subcomponent == "Piano"]$Mean+3*duration_all[Subcomponent == "Piano"]$SD & Mean > duration_all$Mean-3*duration_all[Subcomponent == "Piano"]$SD]
print(excluded_duration_pia)
```
- The number of excluded performance: `r duration_all[Subcomponent == "Piano"]$N-nrow(excluded_duration_pia)`

<!-- ```{r export, include = FALSE} -->
<!-- duration_valid <- dt_duration[, .(N = length(normDu), Mean = mean(normDu)), .(SubNr, TrialNr)] -->
<!-- fwrite(duration_valid, "./duration_valid.csv") -->
<!-- ``` -->
