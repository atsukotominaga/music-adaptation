...
```
- The number of excluded performance: `r duration_all[Subcomponent == "Legato"]$N-nrow(excluded_duration_leg)`
...
```
- The number of excluded performance: `r duration_all[Subcomponent == "Staccato"]$N-nrow(excluded_duration_sta)`
