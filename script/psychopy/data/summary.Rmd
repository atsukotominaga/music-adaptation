...
- 64 stimuli, consisting of high (both articulation and dynamics implemented), articulation-only (only articulation implemented), dynamics-only (only dynamics implemeneted) and low (none of them implemented).
