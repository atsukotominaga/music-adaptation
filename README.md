...
# data
Filtered and trimmed data files for analysis (see details: [Workflow](https://github.com/atsukotominaga/music-teaching/tree/main/experiment-1/analysis/preprocessor))
